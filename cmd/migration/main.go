...
func main() {
	...
	var psn = `postgres://rmrzbpoh:WOIBVdYvcSJzbfIxweOLPvBS0f-zAEQe@raja.db.elephantsql.com:5432/rmrzbpoh`
	...
	checkErr(err)
	createSchema(db, &takrib.Company{}, &takrib.Location{}, &takrib.Role{}, &takrib.User{})
