...
func (u *User) Update(db orm.DB, user *takrib.User) error {
	return db.Update(user)
}

// List returns list of all users retrievable for the current user, depending on role
func (u *User) List(db orm.DB, qp *takrib.ListQuery, p *takrib.Pagination) ([]takrib.User, error) {
	var users []takrib.User
...
func (u *User) Delete(db orm.DB, user *takrib.User) error {
