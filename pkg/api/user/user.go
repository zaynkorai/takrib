...
func (u *User) Create(c echo.Context, req takrib.User) (*takrib.User, error) {
...
func (u *User) List(c echo.Context, p *takrib.Pagination) ([]takrib.User, error) {
	au := u.rbac.User(c)
	q, err := query.List(au)
	if err != nil {
		return nil, err
...
func (u *User) View(c echo.Context, id int) (*takrib.User, error) {
...
func (u *User) Update(c echo.Context, req *Update) (*takrib.User, error) {
