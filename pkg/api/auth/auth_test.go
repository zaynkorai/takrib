...
func TestAuthenticate(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (*takrib.User, error) {
		...
		},
		{
			...
			jwt: &mock.JWT{
				GenerateTokenFn: func(u *takrib.User) (string, string, error) {
...
func TestRefresh(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByTokenFn: func(db orm.DB, token string) (*takrib.User, error) {
					return nil, takrib.ErrGeneric
				},
			},
		},
